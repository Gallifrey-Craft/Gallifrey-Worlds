...
public class GallifreyWorldsMod {
	...
	public GallifreyWorldsMod() {
		...
		GallifreyWorldsModBlocks.REGISTRY.register(bus);

		GallifreyWorldsModItems.REGISTRY.register(bus);

		GallifreyWorldsModTabs.REGISTRY.register(bus);
